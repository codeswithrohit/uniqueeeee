...
const ContactUs = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        toast.success('Our representative will be connect with you in few minutes!');
                ...
                <div class="bg-[#011c2b] rounded-lg p-6 h-full max-lg:order-1">
                    ...
                    <ul class="mt-16 space-y-8">
                        ...
                        <li class="flex items-center">
                            ...
                            <a href="javascript:void(0)" class="text-white text-sm text-gray-500 ml-4">
                            020-41473018 / 41473003
                            </a>
                        </li>
                        <li class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="48px" height="48px" fill='#fff' viewBox="0 0 368.16 368.16">
                            ...
                            <a href="javascript:void(0)" class="text-white text-sm text-gray-500 ml-4">
                            4,Vaishali Apartments, Behind Kothrud Bus Stand,
3,Dahanukar Colony, Kothrud,
Pune 411038.
India
                            </a>
                        </li>
